...
def Generator():
  ...
  up_stack = [
    upsample(512, 4, apply_dropout=True, dropout_value=0.5),  # (batch_size, 2, 2, 1024)
    upsample(512, 4, apply_dropout=True, dropout_value=0.5),  # (batch_size, 4, 4, 1024)
    upsample(512, 4, apply_dropout=True, dropout_value=0.5),  # (batch_size, 8, 8, 1024)
...
# checkpoint
checkpoint_dir = './training_checkpointsv32'
...
summary_writer = tf.summary.create_file_writer(
  log_dir + "fitv32/" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S"))
