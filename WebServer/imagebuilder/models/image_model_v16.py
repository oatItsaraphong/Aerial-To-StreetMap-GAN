...
class ImageModelVersion:
    ...
    def Generator(self):
        ...
        up_stack = [
            self.upsample(512, k_size, apply_dropout=True),  # (batch_size, 2, 2, 1024)
            self.upsample(512, k_size, apply_dropout=True),  # (batch_size, 4, 4, 1024)
            self.upsample(512, k_size, apply_dropout=True),  # (batch_size, 8, 8, 1024)
